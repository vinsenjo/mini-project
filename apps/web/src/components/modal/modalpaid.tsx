...
export default function ModalPaid() {
    ...
    return (
        <section>
            <button className="btn w-48 bg-black text-white hover:border-[#FF7B4F] hover:bg-[#FF7B4F] text-xl" onClick={() => (document.getElementById('my_modal_1') as HTMLFormElement).showModal()}>Paid</button>
            <dialog id="my_modal_1" className="modal ">
                <div className="modal-box w-full">
                    <h1 className="font-serif text-5xl font-bold flex justify-center">Ticketist</h1>
                    <p className=" flex justify-center pt-3 px-2">Let's make your event exciting and engaging full of energy only on Ticketist</p>
                    <Formik
                    ...
                    >
                        {({ setFieldValue, values }) => (
                            <Form>
                                ...
                                <div className="pt-5">
                                    <button type="submit" className="border-2 font-semibold rounded-lg border-[#FF7B4F] bg-[#FF7B4F] text-white h-9 w-full  ">Create event paid</button>
                                </div>
                            </Form>
                        )}
                    </Formik>
