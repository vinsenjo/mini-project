    ...
    return (
        <section className="bg-[#e1e1e1] px-7 pt-4  ">
            <div className="px-10 flex gap-7 text-black rounded-lg ">
                <select className="rounded-md bg-white w-[150px]" value={select} onChange={handleChange}>
                ...
                <DatePicker className=" w-[150px]  bg-white max-w-xs h-10 rounded-md p-2" selected={startDate} onChange={(date) => setStartDate(date!)} />
            </div>
