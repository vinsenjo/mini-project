...
export default function Card() {
    const data: IData[] = [
        {
            img: '/img/Synchronize Fest.jpeg',
            judul: 'Synchronize Fest',
            tanggal: 'Sat, Dec 14 • 14:00 AM',
            tempat: 'lapangan persuasif bandung',
            harga: 299.512,
        },
        {
            img: '/img/jj3.jpeg',
            judul: 'Java Jazz',
            tanggal: 'Sat, Octa 19 • 20:00 PM',
            tempat: 'JX Internasional, Surabaya',
            harga: 799.512,
        },
        {
            img: '/img/so71.jpeg',
            judul: 'Hammersonic',
            tanggal: 'Sat, Dec 14 • 18:00 PM',
    ...
    return (
        <section className="bg-[#e1e1e1] px-7 pt-4  ">
            ...
            <div className="bg-[#e1e1e1] flex lg:flex-row lg:flex-wrap flex-col gap-4 lg:py-6 py-4 lg:mx-5     text-black">
                {data.map((item, key) => (
                    <div
                        key={key}
                        className="card card-compact bg-white w-[340px] shadow-xl rounded-2xl"
                    >
                        <figure>
                            <img
                                src={item.img}
